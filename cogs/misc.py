...
class Misc(commands.Cog):
    ...
    async def info(self,ctx):
        ...
        embed.add_field(name="help command:", value="` h!helpplus `", inline=False)
        embed.add_field(name="list of prefixes:", value="` . ` ` h! `", inline=False)
        #https://discord.com/api/oauth2/authorize?client_id=804194845513613313&permissions=8&scope=bot
        embed.add_field(name="OAuth Invite:", value="http://bit.ly/XStatsOauth", inline=False)
        #longurl is https://discord.com/oauth2/authorize?client_id=804194845513613313&permissions=8&scope=bot
        embed.add_field(name="support server:", value="https://discord.gg/R855EPMvNe", inline=False)
        embed.add_field(name="Github:", value="code availible on github: https://github.com/XCRunnerS/XCStatsbot", inline=False)
        embed.add_field(name="Donation link:", value="donate at https://ko-fi.com/xcrunners to keep me running", inline=False)
        embed.add_field(name='Support Discord:', value='https://discord.gg/R855EPMvNe', inline=False)
    ...
    async def helpplus(self,ctx):
        ...
        embed.add_field(name="Contact Developer:", value="```@XCRunnerS#7188```", inline=False)
        embed.add_field(name="list of commands:", value="type\n` h!help `\nfor a list of commands", inline=False)
        embed.add_field(name="list of prefixes:", value="` . ` ` h! `", inline=False)
        embed.add_field(name="support server:", value="https://discord.gg/R855EPMvNe", inline=False)
